...
namespace PongGame
{
    class SingleLeaderboardScene : Scene, IScene
    {
        ...
        public SingleLeaderboardScene(SceneManager sceneManager, bool check, int playerScore) : base(sceneManager)
        {
            if (exit == false)
            {
                // Set the title of the window
                sceneManager.Title = "Pong - Singleplayer leaderBoards";
        ...
        public void Render(FrameEventArgs e)
        {
            ...
            if (permissionToSubmit == true)
            {
                GUI.Label(new Rectangle(0, (int)(fontSize / 2f), (int)width, (int)(fontSize * 2f)), "Singleplayer LeaderBoards: - Highscore!", (int)fontSize / 2, StringAlignment.Center, Color.DarkGreen);
            }
            else
            {
                GUI.Label(new Rectangle(0, (int)(fontSize / 2f), (int)width, (int)(fontSize * 2f)), "Singleplayer LeaderBoards:", (int)fontSize / 2, StringAlignment.Center);
            }
